...
productos.forEach((producto) => {
    ...
    cardBody.innerHTML = `
        ...
        <p class="card-text cardProducto__info"><i class="fa-solid fa-business-time cardProducto__icon"></i><small class="text-muted">Cantidad en stock: <strong class="cardProducto__stock cardProducto__strong">${producto.Stock}</strong></small></p>
    `;
